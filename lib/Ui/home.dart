...
BlocProvider.of<AllcarsBloc>(context).add(Fetchallcarsevent());
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            Row(
              ...
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                GestureDetector(onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (_)=>Search()));},
                  child: Container(
                    width: 292.w,
                    height: 48.h,
  ...
  builder: (context, state) {
    ...
    if (state is AllcarsBlocLoaded) {
      allcardata =BlocProvider.of<AllcarsBloc>(context).allcarsmodel;
    return GestureDetector(onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (_)=>product()));},
                child: GridView.count(physics: NeverScrollableScrollPhysics(),
                  ...
                  shrinkWrap: true,
                  children: List.generate(allcardata.length,

                          (index) {
                    return   FutureBuilder<List<Placemark>>(
                      future: _getVechileAddress(allcardata[index]
                          .location!
                          .coordinates!
                          .first
                          .toString(),
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                decoration: ShapeDecoration(
                                  image: DecorationImage(
                                    image: NetworkImage(allcardata[index].photos![0].toString()),
                                    fit: BoxFit.cover,
                                  ),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.only(
                              ...
                              Row(
                                children: [
                                  Padding(
                                    padding:  EdgeInsets.only(left: 9.w),
                                    child: Text(
                                      allcardata[index].brand.toString(),
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        color: Color(0xFFF7F5F2),
                                        fontSize: 16.w,
